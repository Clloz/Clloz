'''
Author: Clloz
Date: 2020-11-17 03:26:47
LastEditTime: 2020-11-17 03:47:35
LastEditors: Clloz
Description: 
FilePath: /Clloz/getTopFollowers.py
    ...
    for i in range(1, 100000):
        ...
        for follower in page:
            ...
            if info["following"] > 5000 and info["public_repos"] < 50:
                ...
                continue
            followers.append((info["followers"], info["login"], info["id"],
                              info["name"] if info["name"] else info["login"]))
            print(followers[-1])
